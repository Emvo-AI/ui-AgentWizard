...
function NavBar({isMenuOpen, setIsMenuOpen} : {isMenuOpen: boolean, setIsMenuOpen: (value: boolean) => void}) {
  ...
  return (
    <>
      <div className={`fixed nav absolute flex flex-row items-center border-r border-black border-1 justify-between h-[7vh] bg-[#161730]  top-0 pl-8 pr-8 z-[50] py-2 ${isMenuOpen ? "w-[80vw] left-[20vw]" : "w-[95vw] left-[5vw]"}`}>
        <div className='flex flex-row items-center h-full justify-between gap-3 text-white font-bold'>
          ...
          {/* <div className='flex flex-row bg-[#00031C] rounded-xl py-2 pr-3 pl-6 gap-6 items-center text-white font-bold'>
