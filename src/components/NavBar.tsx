...
function NavBar({isMenuOpen, setIsMenuOpen} : {isMenuOpen: boolean, setIsMenuOpen: (value: boolean) => void}) {
  ...
  return (
    <>
      <div className={`fixed nav absolute flex flex-row items-center border-r border-black border-1 justify-between h-[9vh] bg-[#161730]  top-0 pl-8 pr-8 z-[50] ${isMenuOpen ? "w-[80vw] left-[20vw]" : "w-[95vw] left-[5vw]"}`}>
